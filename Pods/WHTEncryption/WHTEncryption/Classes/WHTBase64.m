...
{
    if (string == nil)
        [NSException raise:NSInvalidArgumentException format:@"dataWithBase64EncodedString string params is nil"];
    if ([string length] == 0)
        return [NSData data];
...
{
    NSData *data=[self decodeToDataWitEncodedString:string];
